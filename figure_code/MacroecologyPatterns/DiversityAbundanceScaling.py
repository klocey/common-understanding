...
fig = figplot(df3['N'], df3['R'], xlab, ylab, fig, 1)

xlab = '$log$'+r'$_{10}$'+'($N$)'
ylab = 'Dominance ($D$), '+r'$log_{10}$'
fig = figplot(df3['N'], df3['D'], xlab, ylab, fig, 2)

xlab = '$log$'+r'$_{10}$'+'($N$)'
ylab = 'Evenness ($E$), ' +r'$log_{10}$'
fig = figplot(df3['N'], df3['E'], xlab, ylab, fig, 3)

xlab = '$log$'+r'$_{10}$'+'($N$)'
ylab = 'Richness ($S$), ' +r'$log_{10}$'
fig = figplot(df3['N'], df3['S'], xlab, ylab, fig, 4)
